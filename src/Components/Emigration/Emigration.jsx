...
import bg from "../../DESKTOP/emigration.webp";
...
import newbg from "../../NEW ASSETS/MOBILE OTHER PAGES/emigartion.webp";
    ...
    return (
      <div className=" w-full min-h-screen h-auto my-font">
        ...
        <div className=" w-[1150px] h-auto flex mx-auto justify-between my-10">
          <div className="">
            <h1 className=" uppercase font-bold text-black text-l2xl">
              Emigration service
            </h1>
            <h1 className=" text-black text-sm w-[600px] font-medium mt-5">
              Emigration is the act of leaving a resident country or place of
              residence with the intent to settle elsewhere.All persons, having
              ECR endorsed passports and going to any of the 17 ECR countries
              for taking up employment require emigration clearance.Emigration
              Clearance for a particular country shall be granted in accordance
              with the policy/orders of Government of India, as in force from
              time to time.
            </h1>
          </div>
          <div>
            ...
            <div className=" mt-5 w-96 h-[250px] bg-[#4D5BDA] px-5 pt-5">
              ...
              <div className=" mt-5">
                <div className=" flex gap-3">
                  ...
                  <h1 className=" text-white font-semibold">91 9544229813</h1>
                </div>
                <div className=" flex gap-3">
                  <h1 className=" text-white text-3xl">
                    <HiMail />
    ...
    <div className=" w-full my-font">
      ...
      <div className=" my-10 px-5">
        <div className=" flex flex-col gap-2">
          <h1 className=" uppercase font-bold text-2xl">emigration service</h1>
          <h1 className=" text-sm font-semibold">
            Emigration is the act of leaving a resident country or place of
            residence with the intent to settle elsewhere.All persons, having
            ECR endorsed passports and going to any of the 17 ECR countries for
            taking up employment require emigration clearance.Emigration
            Clearance for a particular country shall be granted in accordance
            with the policy/orders of Government of India, as in force from time
            to time.
          </h1>
        </div>
      </div>
