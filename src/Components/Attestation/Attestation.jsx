...
import bg from "../../DESKTOP/attestation.webp";
...
import newbg from "../../NEW ASSETS/MOBILE OTHER PAGES/attestaion.webp";
        ...
        <div className=" w-[1150px] h-auto flex mx-auto justify-between my-10">
          <div className="">
            ...
            <h1 className=" text-black text-sm w-[600px] font-medium mt-5">
              Attestation is a legal acknowledgment of the authenticity of a
              document and a verification that proper processes were followed.We
              offer a wide range of services such as HRD/Home Attestation, MEA
              Attestation, Apostille Attestation, Saudi Embassy Attestation,
              Qatar Embassy Attestation, UAE Embassy Attestation, Kuwait Embassy
              Attestation. Fly Greenz Holidays Attestation facilitates complete
              solutions for embassy and apostille attestation services,
              notarization services, chamber attestations and all types of
              certificate attestations for all embassies in India ensuring the
              secure processing of documents in precise time.We are doing all
              country attestation.We are providing the attestation very fast and
              cheapest price.
            </h1>
          </div>
          <div>
    ...
    <div className=" w-full my-font">
      ...
      <div className=" my-10 px-5">
        <div className=" flex flex-col gap-2">
          <h1 className=" uppercase font-bold text-2xl">attestation service</h1>
          <h1 className=" text-sm font-semibold">
            Attestation is a legal acknowledgment of the authenticity of a
            document and a verification that proper processes were followed.We
            offer a wide range of services such as HRD/Home Attestation, MEA
            Attestation, Apostille Attestation, Saudi Embassy Attestation, Qatar
            Embassy Attestation, UAE Embassy Attestation, Kuwait Embassy
            Attestation. Fly Greenz Holidays Attestation facilitates complete
            solutions for embassy and apostille attestation services,
            notarization services, chamber attestations and all types of
            certificate attestations for all embassies in India ensuring the
