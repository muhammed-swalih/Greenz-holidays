...
import bg from "../../DESKTOP/VISTING_VISA_BG.webp";
...
import newbg from "../../NEW ASSETS/MOBILE OTHER PAGES/visting.webp";
function VisitingVisa() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  if (isMedium) {
    return (
      <div className=" w-full min-h-screen h-auto my-font">
        <div
          className=" w-full h-60 bg-cover bg-black "
          style={{ backgroundImage: `url(${newbg})` }}
        >
          <div className=" bg-gradient-to-b from-white h-60">
            <HomeNavbar />
        ...
        <div className=" w-[1150px] h-auto flex mx-auto justify-between my-10">
          <div className="">
            <h1 className=" uppercase font-bold text-black text-2xl">
              visiting visa service
            </h1>
            <h1 className=" text-black text-sm w-[600px] font-medium mt-5">
              We have a full-fledged department for visa procurement. We take
              care of doing the cumbersome work of visa processing the
              application at your request. All you have to do is to contact us
              and provide us the necessary documents and we will process your
              documents as needed. We help in document preparation, filling out
              forms and ensure all necessary fields are correctly filled. This
              eliminates future problems in obtaining your visa
            </h1>
          </div>
          <div>
    ...
    <div className=" w-full my-font">
      ...
      <div className=" my-10 px-5">
        <div className=" flex flex-col gap-2">
          <h1 className=" uppercase font-bold text-2xl">visiting visa</h1>
          <h1 className=" text-sm font-semibold">
            We have a full-fledged department for visa procurement. We take care
            of doing the cumbersome work of visa processing the application at
            your request. All you have to do is to contact us and provide us the
            necessary documents and we will process your documents as needed. We
            help in document preparation, filling out forms and ensure all
            necessary fields are correctly filled. This eliminates future
            problems in obtaining your visa
          </h1>
        </div>
      </div>
