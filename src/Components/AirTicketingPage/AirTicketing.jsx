    ...
    if (isMedium) {
        return (
            <div className=' w-full min-h-screen h-auto my-font'>
                <div className=' w-full h-60 bg-cover ' style={{ backgroundImage: `url(${newbg})` }}>
                ...
                <div className=' w-[1150px] h-auto flex mx-auto justify-between my-10'>
                    <div className=''>
                        <h1 className=' uppercase font-bold text-black text-2xl'>air ticketing service</h1>
                        <h1 className=' text-black text-sm
                         w-[600px] font-medium mt-5'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                            Why do we use it?
